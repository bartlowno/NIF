...
%Return a list of available datums if called without input arguments

    if nargin==0
        value=deblank(data(:,1));
        return
    end

%Match requested datums with those available

	names=cellstr(names);
	for i=length(names):-1:1
        I=strmatch(upper(names{i}),data(:,1),'exact');
        if isempty(I)
            value(i,:)=[NaN NaN NaN NaN NaN];
        else
            value(i,:)=data{I,2};
        end
	end
...
data={'ABINDAN              ', [-1.121450e+002 -5.475071e-005  -162   -12   206]
      ...
      'CH-1903              ', [ 7.398450e+002  1.003748e-005   674    15   405]
      ...
      'DJAKARTA (BATAVIA)   ', [ 7.398450e+002  1.003748e-005  -377   681   -50]
      ...
      'INDIAN BANGLADESH    ', [ 8.606550e+002  2.836137e-005   289   734   257]
      'INDIAN THAILAND      ', [ 8.606550e+002  2.836137e-005   214   836   303]
      'IRELAND 1965         ', [ 7.968110e+002  1.196002e-005   506  -122   611]
      ...
      'KANDAWALA            ', [ 8.606550e+002  2.836137e-005   -97   787    86]
      'KERGUELEN ISLAND     ', [-2.510000e+002 -1.419270e-005   145  -187   103]
      'KERTAU 1948          ', [ 8.329370e+002  2.836137e-005   -11   851     5]
      ...
      'MASSAWA              ', [ 7.398450e+002  1.003748e-005   639   405    60]
      'MERCHICH             ', [-1.121450e+002 -5.475071e-005    31   146    47]
      'MICHELIN             ', [ 1.614000e+003  1.127918e-004  1118    23    66]
      ...
      'NAD83                ', [ 0.000000e+000 -1.643484e-011     0     0     0]
      ...
      'NETHERLANDS          ', [ 7.400000e+002  1.003748e-005   593    26   478]
      ...
      'RT 90                ', [ 7.398450e+002  1.003748e-005   498   -36   568]
      ...
      'SCHWARZECK           ', [ 6.531350e+002  1.003748e-005   616    97  -251]
      ...
      'TIMBALAI 1948        ', [ 8.606550e+002  2.836137e-005  -689   691   -46]
      'TOKYO                ', [ 7.398450e+002  1.003748e-005  -128   481   664]
      ...
      'WGS 72               ', [ 2.000000e+000  3.121058e-008     0     0     5]
      'WGS 84               ', [ 0.000000e+000  0.000000e+000     0     0     0]
